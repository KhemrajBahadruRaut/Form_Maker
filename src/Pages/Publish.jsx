    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-blue-50 py-8 px-4">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-3xl font-bold text-gray-800 mb-8">Publish Your Form</h1>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="text-lg font-bold text-gray-800">Ready to Publish</h2>
            ...
            {error && (
              <div className="bg-white rounded-2xl shadow-sm border border-red-200 p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-red-700">Publication failed</p>
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-emerald-200 overflow-hidden">
                ...
                <div className="p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-emerald-800">Published Successfully!</h2>
                      <p className="text-emerald-600 text-sm">Your form is live and ready to collect responses.</p>
                    </div>
                  </div>
